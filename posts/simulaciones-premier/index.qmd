...
Es claro para todos que el Premier fue dominado por la participación de la raza olimpico, seguida desde lejos por el titán y el faerie (goblin), mientras que los perdedores en popularidad son las razas "verdes y amarillas".
...
::: columns
::: {.column width="57%"}
![Cartas nuevas de Kit Racial Olímpico](olimpicos.png)
:::
...
Si tan sólo 1 olímpico más hubiera pasado la top, entonces los odds aumentan multiplicativamente, de la forma
...
El grosor de las líneas en el eje horizontal indican vagamente si cierto número de jugadores con la misma raza es algo frecuente de ver, por ejemplo, en 10000 simulaciones ni una sola vez hubo 20 ni más de 21 jugadores con la misma raza en el top 32. Lo último que hay por explicar es el error estándar, que es un indicador de la incertidumbre del cálculo de $\beta_1$ y se expresa como una delgada sombra gris en torno a la línea <span style="color: #E64833;">rojiza</span> del modelo logístico, denotando que cabe poca duda que los parámetros del modelo se ajusten a la hipótesis propuesta.
