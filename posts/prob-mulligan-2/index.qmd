...
![](1oro-1robo.png){fig-alt="Manos frecuentes con los mazos faerie, héroe y faraón"}
...
![](tom-thumb-rhiannon.png){fig-alt="Tom Thumb y Rhiannon son cartas de robo explosivo"}
...
![](urisk.png){fig-alt="Ramificaciones de jugar Urisk"}
...
![](tuatha.png){fig-alt="Tuatha de Dannan roba 2 cartas y sale del juego"}
