...
titulos <- tribble(
  ~tor, ~titulo,
  "CL1949", "fas fa-chess-king,fas fa-shield-halved",
  "CL3418", "fas fa-chess-king",
  "CL869", "fas fa-chess-king",
  "CL1428", "fab fa-brave",
  "CL2249", "fab fa-brave,fas fa-shield-halved,fas fa-shield-halved",
  "CL1000", "fas fa-shield-halved,fas fa-shield-halved,fas fa-shield-halved,fas fa-shield-halved,fas fa-shield-halved",
  "CL5859", "fas fa-shield-halved",
  "CL336",  "fas fa-shield-halved,fas fa-shield-halved",
  "CL14340", "fas fa-shield-halved",
  "CL5205", "fas fa-shield-halved",
  "CL13213", "fas fa-shield-halved,fas fa-shield-halved",
  ...
  "CL10997", "fas fa-shield-halved",
  "CL889", "fas fa-shield-halved",
  "CL764", "fas fa-chess-king",
  "CL13481", "fas fa-shield-halved,fas fa-shield-halved",
  "CL888", "fas fa-shield-halved",
  "CL9937", "fas fa-shield-halved",
  "CL7722", "fas fa-shield-halved",
  "CL4638", "fas fa-shield-halved",
  "CL8797", "fas fa-shield-halved",
  "CL2737", "fas fa-shield-halved",
  "CL13851", "fas fa-shield-halved,fas fa-shield-halved",
  "CL16483", "fab fa-brave"
)
```
...
ranking_actualizado |> 
  ...
  cols_move(c(nombre, tor, raza, team, ciudad, wr, elo_actual, elo_diff, titulo), rank_actual) |>
  tab_options(
  ...
  sub_missing(c(rank_diff_abs, elo_diff, titulo, ciudad), missing_text = "") |>
  ...
  cols_align("left", c(rank_diff_abs, elo_diff, titulo)) |> 
  cols_align("right", c(dir)) |> 
  cols_hide(team) |> 
