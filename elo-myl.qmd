...
ranking_actualizado |> 
  ...
  cols_label(
    rank_actual = gt::html(gtExtras::with_tooltip("#", "Ranking y puestos subidos o bajados")),
    rank_diff_abs = "",
    # dir ~ "",
    dir = "",
    tor = md("**TOR**"),
    nombre = md("**Nombre**"),
    raza = gt::html(gtExtras::with_tooltip("Raza favorita", "Raza más jugada en los últimos 5 torneos o ligas")),
    team = md("**Team**"),
    ...
    elo_actual = md("**Elo**"),
    elo_diff = gt::html(gtExtras::with_tooltip("+/-", "Puntos ganados o perdidos"))
  ) |> 
