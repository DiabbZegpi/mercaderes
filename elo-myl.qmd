...
resultados_razas <- 
  resultados_longer |> 
  left_join(torneos |> select(id_torneo, tor, raza), by = join_by(id_torneo, tor)) |> 
...
ranking_actualizado |> 
  ...
  cols_move(c(nombre, tor, raza, team, wr, elo_actual, elo_diff), rank_actual) |>
  tab_options(
